...
| 15 | `8g: 15 minute call booked - Charlotte` ✅ **MIGRATED 2026-06-04** | **Calendly: Invitee Created** | monday Get Items by Column Value → **monday Update Item** → Slack | Re-pointed to `update-by-email` writing `fifteen_minute_call: "Booked"`. Monday steps left in place ~1wk as safety net, then remove. |
| 16 | `8g: 15 minute call booked - Becky` ✅ **MIGRATED 2026-06-05** | **Calendly: Invitee Created** | Same as 15 | Was mislabeled "Tessa" — actually Becky's. Renamed + re-pointed to `update-by-email` (`fifteen_minute_call: "Booked"`). |
| 16b | `8g: 15 minute call booked - Anoop` ✅ **MIGRATED 2026-06-05** | **Calendly: Invitee Created** | Same as 15 | Re-pointed to `update-by-email` (`fifteen_minute_call: "Booked"`). Calendly trigger test skipped (no recent bookings to sample — works on live runs). |
