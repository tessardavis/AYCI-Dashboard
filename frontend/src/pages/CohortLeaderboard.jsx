...
import { Trophy, Award, Loader2, RefreshCw, Medal } from "lucide-react";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="font-semibold text-[var(--ayci-ink)] truncate">{e.name || "(no name)"}</div>
                      {e.email && (
