...
import { LineChart, Mountain, Rocket, Settings as SettingsIcon, LogOut, Search, Calendar, GraduationCap, AlertTriangle, UserCircle2, MessageCircle, Menu, X, Bell, Sparkles, Trophy, LifeBuoy, ChevronDown, Video, Webhook, Receipt, ChevronsLeft, ChevronsRight, BookOpen, Award } from "lucide-react";
...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { to: "/wins", label: "Wins & Testimonials", icon: Award, testid: "sidebar-nav-wins", board: "students" },
